                ...
                <table className="border-collapse w-full ">
                    ...
                    <tbody>
                        <tr className='text-center'>
                            <td><img alt="Product-Image" src="https://cf.shopee.co.th/file/ed717f1a6930d2aa5b23e481a93ad6e0" width="200" height="150" style={{ borderRadius: "30px" }}></img></td>
                            <td data-testid="Name">เสื้อ</td>
                            <td data-testid="Price">200</td>
                            <td>
                                <div>
                            ...
                            <td data-testid="TotalPrice">600</td>
                            <td >
